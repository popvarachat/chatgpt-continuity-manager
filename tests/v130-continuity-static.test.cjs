...
assert.match(source, /@version\s+1\.5\.4/);
...
assert.match(source, /UAIOS_CONTINUITY_VERSION = '1\.5\.4'/);
...
assert.match(source, /window\.open\(preopenTarget, '_blank'\)/);
assert.match(source, /uaiosContinuityPrepareRollover\(preopenedTab = null\)/);
...
console.log('v1.5.4 continuity static tests: PASS');