...
assert.match(source, /UAIOS_CONTINUITY_VERSION = '1\.5\.3'/);
...
assert.match(source, /preopenedTab\.location\.replace\(targetUrl\)/);
...
console.log('v1.5.3 continuity static tests: PASS');